                                   ...
                                   @include('menu')
                                    ...
                                    <nav class="elementor-nav-menu--dropdown elementor-nav-menu__container"
                                        ...
                                        <ul id="menu-2-1131842" class="elementor-nav-menu">
                                            ...
                                            <li
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-30783">
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu elementor-nav-menu--dropdown">
                                                    <li
                                                        ...
                                                        <a href="https://www.btaskee.com/en/" hreflang="en-US"
                                                            lang="en-US" class="elementor-sub-item"
                                                            tabindex="-1">English</a>
                                                    </li>
                                                    <li
                                                        class="lang-item lang-item-69 lang-item-ko menu-item menu-item-type-custom menu-item-object-custom menu-item-31651-ko">
                                                        <a href="https://www.btaskee.com/ko/" hreflang="ko-KR"
                                                            lang="ko-KR" class="elementor-sub-item"
                                                            tabindex="-1">한국어</a>
                                                    </li>
                                                    <li
                                                        class="lang-item lang-item-2330 lang-item-th menu-item menu-item-type-custom menu-item-object-custom menu-item-31651-th">
                                                        <a href="https://www.btaskee.com/th/" hreflang="th"
                                                            lang="th" class="elementor-sub-item"
                                                            tabindex="-1">ไทย</a>
                                                    </li>
                                                </ul>
                                            </li>
